...
class LineEdit(QLineEdit):
    ...
    def __init__(self,sz = None):
        super(LineEdit,self).__init__(sz)#父类输入文字内容
        self.setReadOnly(True)
...
class UserListItem(QListWidgetItem):
    ...
    def __init__(self, parent, usrId, name = DEFAULT_USER,
            ...
            group = DEFAULT_GROUP):
        super(UserListItem,self).__init__(None, None, QListWidgetItem.UserType)#parent给None才能正确的insertItem而不能addItem

        self._id = usrId
        self._group = group #这两个参数放在本类，其它参数放到子类
        self._parent = parent
...
class GroupItem(QWidget,QObject):
    ...
    def setName(self,name):
        self._name = name
        self._nameWidget.setText('%s'%(name))
        self._nameWidget.setReadOnly(True)
    def getNameInput(self):
        return self._nameWidget.text()
    def getName(self):
...
class GroupListItem(QListWidgetItem):
    ...
    def __init__(self, parent, name = DEFAULT_GROUP):
        super(GroupListItem,self).__init__(None, None,QListWidgetItem.UserType)#parent给None才能正确的insertItem而不能addItem
...
if __name__=='__main__':
    ...
    ul.addGroup(u'team')
    ul.addUser(u'甜心吉吉',group = u'team')
